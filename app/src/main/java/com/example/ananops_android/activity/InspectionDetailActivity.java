...
//                list_item4.add("单据状态");list_item4.add("报修单号");
        ...
        list_fragment.add(InspectionFragment.newIntance(list_item1,list_value1));
        list_fragment.add(InspectionFragment.newIntance(list_item2,list_value2));
        list_fragment.add(InspectionFragment.newIntance(list_item3,list_value3));
        list_fragment.add(InspectionFragment.newIntance(list_item4,list_value4));
    }
