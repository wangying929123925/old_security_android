...
import com.example.ananops_android.adapter.base.ItemViewDelegateManager;

import java.util.List;

public class ListMultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    public ListMultiItemTypeAdapter(Context context, List<T> datas) {
        this.mContext = context;
        this.mDatas = datas;
        mItemViewDelegateManager = new ItemViewDelegateManager();
    }

    public ListMultiItemTypeAdapter addItemViewDelegate(ItemViewDelegate<T> itemViewDelegate) {
