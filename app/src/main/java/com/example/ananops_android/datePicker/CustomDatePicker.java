package com.example.ananops_android.datePicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private PickerView mDpvYear, mDpvMonth, mDpvDay, mDpvHour, mDpvMinute;//滚轮效果
     ...
     * 时间单位：时、分
     */
    private static final int SCROLL_UNIT_HOUR = 0b1;//二进制数
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_confirm://确定
                if (mCallback != null) {
                    mCallback.onTimeSelected(mSelectedTime.getTimeInMillis());//1970 年 1 月 1 日的 00:00:00.000到Calendar对象表示的时间之间的毫秒数
                }
                break;
        }
