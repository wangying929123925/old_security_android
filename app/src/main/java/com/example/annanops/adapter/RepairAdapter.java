...
public class RepairAdapter extends RecyclerView.Adapter<RepairAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(ViewHolder holder,int position){//对RecycleView子项进行赋值，
        ...
        switch (repairContent.getRepair_status()){
            case "服务商待接单":
                holder.order_item_button1.setText("接受");
                holder.order_item_button2.setText("拒绝");
            ...
            case"维修工待接单":
                ...
                break;
            case "维修中":
                holder.order_item_button1.setText("开始维修");
                holder.order_item_button2.setText("已经修好");
                holder.order_item_button1.setVisibility(View.VISIBLE);
                break;
            case "待验收":
    ...
    void onItemClick(View v, ViewName viewName, int position) {
        ...
        switch (v.getId()) {
            ...
            case R.id.order_item_button1:
                Toast.makeText(mComtext, "你点击了接受按钮" + (position + 1), Toast.LENGTH_SHORT).show();
                break;
            case R.id.order_item_button2:
                Toast.makeText(mComtext, "你点击了拒绝按钮" + (position + 1), Toast.LENGTH_SHORT).show();
                break;
            default:
